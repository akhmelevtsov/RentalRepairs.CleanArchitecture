...
/// PHASE 1 MIGRATION: Updated to use domain services directly for business logic.
/// Eliminates string-based status comparisons throughout the application.
/// </summary>
public static class TenantRequestDtoStatusExtensions
{
    ...
    /// PHASE 1: Enhanced with domain service business logic.
    /// </summary>
    ...
    /// PHASE 1: Uses domain service for business logic.
    /// </summary>
    public static RentalRepairs.Domain.Services.StatusCategory GetStatusCategory(this TenantRequestDto dto)
    {
...
/// PHASE 1 MIGRATION: Enhanced with domain service business logic.
/// Provides strongly-typed filtering and grouping operations.
/// </summary>
public static class TenantRequestDtoCollectionExtensions
{
    ...
    /// PHASE 1: Uses domain service for categorization.
    /// </summary>
    public static IEnumerable<TenantRequestDto> ByStatusCategory(this IEnumerable<TenantRequestDto> requests, RentalRepairs.Domain.Services.StatusCategory category)
    {
    ...
    /// </summary>
    public static IEnumerable<TenantRequestDto> ByStatus(this IEnumerable<TenantRequestDto> requests, TenantRequestStatus status)
    {
    ...
    /// </summary>
    public static IEnumerable<TenantRequestDto> ByStatuses(this IEnumerable<TenantRequestDto> requests, params TenantRequestStatus[] statuses)
    {
    ...
    /// PHASE 1: Uses domain service for categorization.
    /// </summary>
    public static Dictionary<RentalRepairs.Domain.Services.StatusCategory, List<TenantRequestDto>> GroupByStatusCategory(this IEnumerable<TenantRequestDto> requests)
    {
    ...
    /// </summary>
    public static Dictionary<TenantRequestStatus, List<TenantRequestDto>> GroupByStatus(this IEnumerable<TenantRequestDto> requests)
    {
    ...
    /// PHASE 1: Uses domain service for priority calculation.
    /// </summary>
