...
public interface ITenantRequestRepository : IRepository<TenantRequest>
{
    ...
    /// </summary>
    Task<IEnumerable<TenantRequest>> GetByStatusAsync(TenantRequestStatus status,
    ...
    /// </summary>
    Task<IEnumerable<TenantRequest>> GetByPropertyIdAsync(Guid propertyId,
        CancellationToken cancellationToken = default);

    /// <summary>
    /// Get all tenant requests assigned to specific worker
    /// </summary>
    Task<IEnumerable<TenantRequest>> GetByWorkerEmailAsync(string workerEmail,
        CancellationToken cancellationToken = default);
    ...
    /// </summary>
    Task<IEnumerable<TenantRequest>> GetByUrgencyLevelAsync(string urgencyLevel,
        CancellationToken cancellationToken = default);
    ...
    /// </summary>
    Task<IEnumerable<TenantRequest>> GetOverdueRequestsAsync(int daysThreshold,
        CancellationToken cancellationToken = default);
    ...
    /// </summary>
    Task<IEnumerable<TenantRequest>> GetBySpecificationAsync(ISpecification<TenantRequest> specification,
        CancellationToken cancellationToken = default);
