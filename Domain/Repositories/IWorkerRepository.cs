...
public interface IWorkerRepository : IRepository<Worker>
{
    ...
    Task<IEnumerable<Worker>> GetBySpecializationAsync(string specialization,
        CancellationToken cancellationToken = default);

    Task<IEnumerable<Worker>> GetActiveWorkersAsync(CancellationToken cancellationToken = default);

    Task<IEnumerable<Worker>> GetBySpecificationAsync(ISpecification<Worker> specification,
        CancellationToken cancellationToken = default);
}
