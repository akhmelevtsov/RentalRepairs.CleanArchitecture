...
public static class SeedDataGenerator
{
    public static List<TestPropertyData> GenerateProperties(int count, int tenantsPerProperty)
    {
        ...
        for (int i = 0; i < count && i < propertyTemplates.Count; i++)
        {
    ...
    public static List<TestWorkerData> GenerateWorkers(int count)
    {
        ...
        var specializations = new[] { "Plumber", "Electrician", "HVAC", "General Maintenance", "Painter", "Carpenter", "Locksmith", "Appliance Repair" };
        var firstNames = new[] { "Mike", "Sarah", "Tom", "Lisa", "David", "Emma", "James", "Anna", "Robert", "Jessica", "Kevin", "Michelle" };
        var lastNames = new[] { "Smith", "Johnson", "Williams", "Brown", "Jones", "Garcia", "Miller", "Davis", "Rodriguez", "Martinez", "Hernandez", "Lopez" };
    ...
    private static List<TestPropertyData> GetPropertyTemplates()
    {
        ...
        {
            new TestPropertyData
            {
                Name = "Sunset Apartments",
                Code = "SUN001",
                Address = new TestAddressData { StreetNumber = "123", StreetName = "Sunset Blvd", City = "Los Angeles", PostalCode = "90210" },
            ...
            new TestPropertyData
            {
                ...
                Code = "MAP001",
                Address = new TestAddressData { StreetNumber = "456", StreetName = "Maple Ave", City = "Portland", PostalCode = "97201" },
            ...
            new TestPropertyData
            {
                ...
                Code = "OAK001",
                Address = new TestAddressData { StreetNumber = "789", StreetName = "Oak Hill Dr", City = "Seattle", PostalCode = "98101" },
            ...
            new TestPropertyData
            {
                ...
                Code = "PIN001",
                Address = new TestAddressData { StreetNumber = "321", StreetName = "Pine Valley Rd", City = "Denver", PostalCode = "80202" },
            ...
            new TestPropertyData
            {
                ...
                Code = "CED001",
                Address = new TestAddressData { StreetNumber = "654", StreetName = "Cedar Park Way", City = "Austin", PostalCode = "73301" },
    ...
    private static List<TestTenantData> GenerateTenantsForProperty(TestPropertyData property, int count)
    {
        ...
        var lastNames = new[] { "Smith", "Doe", "Johnson", "Brown", "Wilson", "Moore", "Taylor", "Anderson", "Thomas", "Jackson" };

        var availableUnits = property.Units.Take(count).ToList();

        for (int i = 0; i < Math.Min(count, availableUnits.Count); i++)
        {
            var firstName = firstNames[i % firstNames.Length];
            var lastName = lastNames[i % lastNames.Length];
            var unit = availableUnits[i];
            var propertyName = property.Name.ToLower().Replace(" ", "").Replace("apartments", "").Replace("condos", "").Replace("residences", "").Replace("townhomes", "");
